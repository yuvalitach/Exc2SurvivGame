package com.example.exc2survivgame;
    ...
    private void initViews() {
        this.menu_BTN_start.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                int idLength = menu_EDT_id.getText().toString().length();
                if (idLength<8 || idLength>9)
                    Toast.makeText(Activity_Menu.this, "Enter an ID between 8 or 9 characters", Toast.LENGTH_SHORT).show();
                else
